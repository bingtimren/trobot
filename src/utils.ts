 ...
 * @param methodWrapper
 */
export function methodWrapperDecorator<
  TargetType,
  MethodFuncType extends (...args: never[]) => unknown
>(
  methodWrapper: (
    thisArg: TargetType,
    originalMethod: MethodFuncType,
    ...args: Parameters<MethodFuncType>
  ) => ReturnType<MethodFuncType>
) {
  return function (
    target: TargetType,

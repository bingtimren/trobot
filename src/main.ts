...
const console = new BaseStreamConsole(process.stdin, process.stdout, process.stdout, cliHandler.handle.bind(cliHandler),
    {
        greetingMessage: "Welcome! For help of commands, type 'help'. To exit, press 'ctrl+c' or 'ctrl+d'.",
        farewellMessage: "Bye!",
        prompt: "command: "
    })
